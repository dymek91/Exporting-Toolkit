...
namespace CryEngine
{
	public struct Matrix3x4
	{
        ...
        public Vector3 GetScale()
        {
            ...
            Vector3 col1= new Vector3(m00, m10, m20);
            Vector3 col2 = new Vector3(m01, m11, m21);
            Vector3 col3 = new Vector3(m02, m12, m22);

            scale = new Vector3(col1.Length, col2.Length, col3.Length);
        ...
        /// <summary>
        /// WARNING: it will clear scale in matrix. Get Scale before using this funcion.
        /// </summary>
        public void DescaleRotation()
        {
